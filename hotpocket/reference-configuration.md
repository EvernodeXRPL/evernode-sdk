...
- ### ***contract***
  ...
  | ***environment***             | The runtime environment variables to be set for contract execution. This is specified as a set json object with variable name as key and the the value. Example: `{ "VAR1": "value 1", "VAR2": 2 }`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
