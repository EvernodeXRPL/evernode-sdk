...
- ### ***contract***
  ...
  | ***environment***             | The runtime environment variables to be set for contract execution. This is specified as a JSON object with variable name as key and the the value. The values should be in string format. Example: `{ "VAR1": "value 1", "VAR2": "2" }`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
